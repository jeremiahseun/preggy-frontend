...
export default function HomeLayout() {
    return (
        <Stack>
            ...
            <Stack.Screen name="search" options={{ title: "What's on your mind?", headerBackButtonDisplayMode: 'minimal', animationMatchesGesture: true, headerLargeTitle: true, headerStyle: {
